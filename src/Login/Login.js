...
class Login extends Component {
	...
	return (
		<>
			<Helmet>
				<title>{`Login - Nord AI`}</title>
			</Helmet>
			<div className="bg-grey-900">
			<div className="container mx-auto min-h-screen flex flex-col md:items-center md:justify-center">
			
				<div>
				<img className="ml-auto mr-auto w-64 h-48 object-cover" src={Logo} />
					<div>
					{/* <div className="text-3xl md:text-5xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 mb-4"> Nord AI*/}
						{/* <div className="absolute top-0 ml-3 left-full bg-gradient-to-r from-gray-500 to-gray-500 text-white text-sm px-2 py-0.5 hidden md:inline-block rounded-md font-normal ">Beta</div> */}
					</div>
				</div>
			...
			<div className="align-bottom flex  transform transition-all sm:align-middle transition flex divide-x divide-gray-300 ">
			  ...
			  <Switch>
				...
				<a href={`https://www.nordai.dk/`} className="block text-center bg-gray-100 text-gray-500 text-sm p-3 rounded-b-lg hover:bg-gray-200 cursor-pointer">
...
<form onSubmit={onLogin}>
					...
					<div className="flex flex-col flex-1">
						<label className="text-gray-400 text-sm block mt-4 inline-block text-left">Kodeord</label>
					...
					<div className="flex flex-col">
						 ...
						 */}
						<a href={`https://www.openaitemplate.ai/contact`} className="mt-4 text-gray-400 text-sm">Glemt dit password?</a>
					</div>
                    </div>
                  </form>
	  </>
...
<form onSubmit={onSignup}>
					...
					<div className="md:flex">
						<div className="flex flex-col min-w-0 md:pr-2 flex-1">
							<label className="text-gray-400 text-sm block mt-4 inline-block text-left">Fornavn</label>
						...
						<div className="flex flex-col min-w-0 md:pl-2 flex-1">
							<label className="text-gray-400 text-sm block mt-4 inline-block text-left">Efternavn</label>
